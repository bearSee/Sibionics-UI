        ...
        return {
            ...
            attributeData: [
                ...
                },
                {
                    ...
                    des: '定义选项的唯一key，用来优化渲染；默认从 props.optionProps.key 取值（若选项唯一key重复，可能需要用到该字段）',
                    type: 'String/Number',
                    values: '-',
                    defaultVal: '-',
                },
                ...
                },
                {
                    ...
                    des: "指定复选选项配置的键/值所对应的code，一般用于配置接口从后台获取数据的情况，默认展示的字段叫value，获取值的字段叫key，可能后台返回的数据中并不包含key和value，而是叫id和name，那么此时你需要配置成{ key: 'id', value: ''name' }",
                    type: 'Object',
                    values: '-',
                ...
                },
                {
                    ...
                    des: '接口请求配置项(如果使用接口请求复选框数据，则传入的 options 无效)',
                    type: 'Object',
                    values: '-',
                    defaultVal: '{ }',
                },
